<fieldset>
    ...
    <table class="w-100">
        ...
        ?>
        <tr>
            <td class="clo cup myClick"><?=$row['title']?></td>
            <td >
                <span>
            ...
            <td class="ct">
                ...
                ?>
                <span class="goodBtn" onclick="add_good(<?=$row['id']?>,1,<?=$row['good']+1?>)">讚</span>
                <?php
                    }else{
                ?>
                <span class="goodBtn" onclick="add_good(<?=$row['id']?>,0,<?=$row['good']-1?>)">收回讚</span>
                <?php
                    }
                }
                ?>
...
<script>
    ...
    function add_good(id,type,good){
        ...
        $.post('./api/add_good.php',{id,type,good},()=>{
            location.reload();
        })
    }
</script>