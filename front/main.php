<div class="d-f news_btn_group">
    <div class="news_btn cup p-10 activebtn" onclick="showNews(1,this)">健康新知</div>
    <div class="news_btn cup p-10" onclick="showNews(2,this)">菸害防治</div>
    <div class="news_btn cup p-10" onclick="showNews(3,this)">癌症防治</div>
    <div class="news_btn cup p-10" onclick="showNews(4,this)">慢性病防治</div>
</div>
<div class="news_list">
    <div class="news_item p-10 activeNews" data-id="1">
        <h1>健康新知</h1>
        資料來源： 行政院衛生署國民健康局
        發佈日期： 2012 / 10 / 07
    ...
    <div class="news_item p-10" data-id="2">
        <h1>菸害防治</h1>
    ...
    <div class="news_item p-10" data-id="3">
        <h1>癌症防治</h1>
    ...
    <div class="news_item p-10" data-id="4">
        <h1>慢性病防治</h1>
        資料來源：中央健康保險局雙月刊第98期
        上稿日期：2012/08/10
        文／游小雯
